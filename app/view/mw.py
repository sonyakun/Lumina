...
from ..common.icon import MyFluentIcon as MFI
...
class AvatarWidget(NavigationWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.avatar = QImage("resource/sonya.png").scaled(
    ...
    def paintEvent(self, e):
        ...
        if not self.isCompacted:
            ...
            painter.drawText(QRect(44, 0, 255, 36), Qt.AlignVCenter, "sonyakun")
...
class LuminaUI(FramelessWindow):
    def __init__(self):
        super().__init__()
        ...
        self.musicInterface = Widget("", self) # Music Interface
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.musicInterface, MFI.HOME, "ホーム")
        self.addSubInterface(self.searchInterface, MFI.SEARCH, "検索")
        self.addSubInterface(self.videoInterface, MFI.CHAT, "チャット")

        self.navigationInterface.addSeparator()

        # add navigation items to scroll area
        self.addSubInterface(
            self.folderInterface, MFI.CLOUD, "ドライブ", NavigationItemPosition.SCROLL
        )
        # for i in range(1, 21):
